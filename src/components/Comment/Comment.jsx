...
const Comment = () => {
    return (
        <div className="flex flex-col lg:flex-row max-w-4xl mx-auto gap-10 my-28">
             ...
             <form className="">
                <h2 className='text-2xl font-semibold py-7 text-blue-900'>Give your important opinion here</h2>
                    ...
                    <br/>
                    <textarea className="textarea textarea-bordered mt-5 pt-5 border-2 rounded-full border-blue-800 w-full" placeholder="Comment"></textarea>
                     <br />
