...
const Navbar = () => {
    ...
    <li><NavLink to='/details/:id' className={({isActive, isPending})=> isPending ? "pending" : isActive ? "text-blue-500 border-r-2 border-blue-500 pr-2" : ""}>Product Details</NavLink></li>
