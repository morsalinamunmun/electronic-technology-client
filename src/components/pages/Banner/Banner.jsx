...
const Banner = () => {
    return (
            <div className="bg-no-repeat bg-cover min-h-screen bg-center" style={{backgroundImage: 'url(https://i.ibb.co/LnnTWS7/banner.png)'}}>
                <Navbar></Navbar>
                    <div className="hero-content grid grid-cols-2 text-left text-neutral-content max-w-6xl mx-auto mt-36">
                        <div className="">
